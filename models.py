...
class Session(TorrentModel):
    class Units(TorrentModel):
        _casts = {
                #'speed-units': listof(str),
                #'speed-bytes': int,
                #'size-units': listof(str),
                #'size-bytes': int,
                #'memory-units': listof(str),
                #'memory-bytes': int,
                }
    ...
    _casts = {
            ...
            #'config-dir': str,
            #'download-dir': str,
            #'download-queue-size': int,
            #'download-queue-enabled': bool,
            #'dht-enabled': bool,
            #'encryption': str,
            #'idle-seeding-limit': int,
            #'idle-seeding-limit-enabled': bool,
            #'incomplete-dir': str,
            #'incomplete-dir-enabled': bool,
            #'lpd-enabled': bool,
            ...
            #'queue-stalled-minutes': int,
            #'rename-partial-files': bool,
            #'rpc-version': int,
            #'rpc-version-minimum': int,
            #'script-torrent-done-filename': str,
            #'script-torrent-done-enabled': bool,
            #'seedRatioLimit': float,
            #'seedRatioLimited': bool,
            #'seed-queue-size': int,
            #'seed-queue-enabled': bool,
            #'speed-limit-down': int,
            #'speed-limit-down-enabled': bool,
            #'speed-limit-up': int,
            #'speed-limit-up-enabled': bool,
            #'start-added-torrents': bool,
            #'trash-original-torrent-files': bool,
            'units': Units,
            #'utp-enabled': bool,
            #'version': str,
        }
